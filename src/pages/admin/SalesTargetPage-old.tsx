      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Manage monthly targets for team leaders</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <GlassCard>
              <div className="space-y-2">
                ...
                <p className="text-3xl font-bold">{teamLeaders.length}</p>
              </div>
            </GlassCard>

            <GlassCard>
              <div className="space-y-2">
                <p className="text-muted-foreground text-sm">Total Targets This Month</p>
            ...
            <GlassCard>
              <div className="space-y-2">
                <p className="text-muted-foreground text-sm">Combined Monthly Target</p>
                <p className="text-3xl font-bold">
                  {targets
