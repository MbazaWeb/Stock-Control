...
interface TargetWithPerformance extends CaptainTarget {
  actual_sales: number;
...
export default function CaptainSalesTargetPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      // Fetch all sales for this captain
      ...
      toast({
        title: 'Error',
        description: 'Failed to load captain targets',
        variant: 'destructive',
      });
    } finally {
      setLoading(false);
